...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-zinc-200/70 bg-white/75 dark:border-white/10 dark:bg-black/60">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <Image
            ...
            width={150}
            height={42}
            className="hidden h-auto w-[130px] dark:block"
          />
          <p className="mt-4 max-w-xs text-sm text-zinc-600 dark:text-zinc-300">
