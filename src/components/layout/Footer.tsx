      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            />
            <p className="mt-3 text-sm text-zinc-500 dark:text-white/55">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 text-sm text-zinc-500 dark:text-white/55 hover:text-[#FF3131] transition-colors"
            >
              <Instagram size={16} />
              @algarvesimracing
            </a>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-heading font-semibold text-sm uppercase tracking-widest text-zinc-400 dark:text-white/40 mb-4">Contact</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-zinc-500 dark:text-white/55">
              ...
              <li>
                <a href="tel:+351965479298" className="flex items-center gap-2 text-sm text-zinc-500 dark:text-white/55 hover:text-[#FF3131] transition-colors">
                  <Phone size={15} className="shrink-0 text-[#FF3131]" />
                  +351 965 479 298
                </a>
              </li>
              <li>
                <a href="mailto:info@algarvesimracing.com" className="flex items-center gap-2 text-sm text-zinc-500 dark:text-white/55 hover:text-[#FF3131] transition-colors">
